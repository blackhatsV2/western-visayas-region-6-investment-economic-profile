...
<body x-data="spreadsheetApp()" class="antialiased font-sans">
    ...
    <div x-show="saving" 
        ...
        <div class="flex flex-col items-center gap-4">
            ...
            <span class="text-white font-bold text-sm tracking-widest uppercase animate-pulse">Saving Changes...</span>
        </div>
    </div>
        ...
        <div class="max-w-full mx-auto px-8 flex items-center justify-between">
            ...
            <div class="flex items-center gap-4">
                <div class="flex bg-white/5 rounded-lg p-1 mr-4">
                    ...
                    <a href="/admin/grid?year={{ $selectedYear }}" class="px-4 py-1.5 rounded-md text-[10px] font-black uppercase transition-all bg-arbitra-emerald text-arbitra-black">Spreadsheet</a>
